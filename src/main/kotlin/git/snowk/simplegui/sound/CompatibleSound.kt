package git.snowk.simplegui.sound
...
enum class CompatibleSound(private val sound8: String?, private val sound912: String?, private val sound13: String?) {
    ...
    private val sound: Sound?
        get() {
            if (SERVER_VERSION_INT == 8) {
                return if (sound8 == null) Sound.valueOf("IRONGOLEM_DEATH") else Sound.valueOf(
                    sound8
                )
            } else if (SERVER_VERSION_INT > 9 && SERVER_VERSION_INT < 13) {
                return if (sound912 == null) Sound.valueOf("ENTITY_IRONGOLEM_DEATH") else Sound.valueOf(
                    sound912
                )
            } else if (SERVER_VERSION_INT >= 13) {
                return if (sound13 == null) Sound.valueOf("ENTITY_IRON_GOLEM_DEATH") else Sound.valueOf(
                    sound13
                )
            } else {
                return null
    ...
    val SERVER_VERSION: String = Bukkit.getServer()
        .javaClass.getPackage()
        .getName().split("\\.".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()[3]
        .substring(1)

    val SERVER_VERSION_INT: Int = SERVER_VERSION
        .replace("1_", "")
